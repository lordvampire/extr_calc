...
export default class MainFlow extends React.Component {
    ...
    gotoNextStep() {
        ...
        Object.keys(this.state.current_state).forEach((key, index) => {
            if (this.state.current_state[key] == "" || this.state.current_state[key] == null){
                ret_val = false;
            }
        })
                            ...
                            <Form>
                                <FormGroup row>
                                    <Col md="6">
                                        ...
                                        <Input name="customer" id="customer" 
                                                placeholder="Kunde" onBlur={e => this.setState({cur_customer: update_state('cur_customer', e)})} noValidate/>
                                    </Col>
                                    <Col md="6">
                                        <Label for="profile_weight">Profilgewicht</Label>
                                        <InputGroup>
                                            <Input name="profile_weight" id="profile_weight" 
                                                    placeholder="Profilgewicht" onBlur={e => { handleChange(e); this.setState({cur_weight: update_state('cur_weight', e)})}} noValidate/>
                                ...
                                <FormGroup row>
                                    <Col md="6">
                                        ...
                                        <Input type="select" name="select" id="profile_type" onBlur={e => this.setState({cur_type: update_state('cur_type', e)})}>
                                            {profile_type_options}
                                        </Input>
                                    </Col>
                                    <Col md="6">
                                        <Label for="profile_complexity">Komplexität</Label>
                                        <Input type="select" name="select" id="profile_complexity" onBlur={e => this.setState({cur_complexity: update_state('cur_complexity', e)})}>
                                            {complexity_options}
                                        </Input>
                                    </Col>
                                </FormGroup>
                                    ...
                                    <Col md="6">
                                        ...
                                        <InputGroup>
                                            <Input name="profile_width" id="profile_width" 
                                                    placeholder="Profilbreite" onBlur={e => { handleChange(e); this.setState({cur_width: update_state('cur_width', e)})}}/>
                                    ...
                                    <Col md="6">
                                        ...
                                        <InputGroup>
                                            <Input name="profile_height" id="profile_height" 
                                                    placeholder="Profilhöhe" onBlur={e => { handleChange(e); this.setState({cur_height: update_state('cur_height', e)})}}/>
                                            <InputGroupAddon addonType="append">[mm] (0....10^6)</InputGroupAddon>
                                        </InputGroup>
                                ...
                                <FormGroup row>
                                    <Col md="6">
                                        ...
                                        <Input type="select" name="select" id="alloy" onBlur={e => this.setState({cur_alloy: update_state('cur_alloy', e)})}>
                                            {alloy_options}
                                        </Input>
                                    </Col>
                                    <Col md="6">
                                        <Label for="profile_surface">Oberfläche</Label>
                                        <Input type="select" name="select" id="profile_surface" onBlur={e => this.setState({cur_surface: update_state('cur_surface', e)})}>
                                            {surface_options}
                                        </Input>
                                    </Col>
                                </FormGroup>
                                <FormGroup row>
                                    <Col md="6">
                                        ...
                                        <InputGroup>
                                            <Input name="profile_length" id="profile_length" 
                                                    placeholder="Kundenlänge" onBlur={e => { handleChange(e); this.setState({cur_length: update_state('cur_length', e)})}}/>
                                            <InputGroupAddon addonType="append">[mm] (0....10^6)</InputGroupAddon>
                                        </InputGroup>
                                    ...
                                    <Col md="6">
                                        ...
                                        <Input type="select" name="select" id="profile_usage" onBlur={e => this.setState({cur_usage: update_state('cur_usage', e)})}>
                                            {usage_options}
                                        </Input>
                                    </Col>
                                </FormGroup>
